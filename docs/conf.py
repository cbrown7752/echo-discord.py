...
extlinks = {
    'issue': ('https://github.com/cbrown7742/discord.py/issues/%s', 'GH-'),
}
...
html_context = {
  'discord_invite': 'https://discord.gg/kqK6bd9S9Y',
  'discord_extensions': [
...
resource_links = {
  'discord': 'https://discord.gg/kqK6bd9S9Y',
  'issues': 'https://github.com/cbrown7752/echo-discord.py/issues',
  'discussions': 'https://github.com/cbrown7752/echo-discord.py/discussions',
  'examples': f'https://github.com/cbrown7752/echo-discord.py/tree/{branch}/examples',
}
